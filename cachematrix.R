## Below are two functions that are used to create a special object that stores an invertible square matrix and 
## caches its inverse. The functons assume that the matrix supplied is always invertible.
